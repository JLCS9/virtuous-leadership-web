...
export default {
  ...
  home: {
    ...
    pillars: {
      magnanimity: {
        ...
        sub: '',
        title: '',
        text: 'La actitud del que sueña en grande y transforma su sueño en misión.',
      },
      humility: {
        badge: 'Humildad',
        sub: '',
  ...
  universidades: {
    ...
    formato: [
      ...
      { label: 'Aplicación al contexto',    sublabel: 'Encuentros presenciales',  title: 'Sesiones moderadas',             text: 'Encuentros presenciales para integrar contenidos y aplicarlos al contexto específico de la institución, moderados por un profesor elegido por ella.' },
    ],
    ...
    participantes_title: 'Participantes',
    ...
    participantes: [
      { title: 'Personal',              text: 'Equipos directivos y administrativos.' },
      { title: 'Profesores',            text: 'Docentes e investigadores.' },
    ...
    conceptos_title: 'Contenido',
    conceptos: [
      { title: 'Temperamento y carácter',       text: 'Comprender la propia estructura biológica (temperamento), y su influencia en el proceso de crecimiento personal (carácter).' },
      { title: 'Corazón, intelecto y voluntad', text: 'Profundizar en la integración interior y identificar los desequilibrios que la paralizan: racionalismo, voluntarismo y sentimentalismo.' },
      { title: 'Misión personal',               text: 'Descubrir tu contribución específica al bien común que nace de tu historia y tus talentos.' },
      { title: 'Magnanimidad',                  text: 'El ideal de la grandeza que aspira a la excelencia humana, confía en sus talentos y transforma sueños en misión.' },
      { title: 'Humildad',                      text: 'El ideal del servicio que escucha, acompaña y empodera a otros.' },
  ...
  // ──────────── TEST CORAZÓN LIBRE — i18n ────────────
  // Labels UI. Los textos largos (heartTestIntro, 8 HTMLs de diagnóstico,
  // about-heart) viven en src/data/heart-support-text.json (extraídos del
  ...
  tbp_heart: {
    ...
    gate: {
      eyebrow: 'Último paso',
      title: 'Recibe tus resultados',
      intro: 'Te enviamos una copia por email y, una vez al mes, ideas prácticas para trabajar tu corazón.',
      fields: { name: 'Nombre', email: 'Email', birth_year: 'Año de nacimiento', sex: 'Sexo' },
      sex_options: { mujer: 'Mujer', hombre: 'Hombre' },
      consent_html: 'Sí, envíame mis resultados por email y suscríbeme al boletín mensual: contenido sobre virtudes y desarrollo del corazón. Cero spam, baja con un clic cuando quieras. Al suscribirte aceptas nuestra <a href="/es/politica-de-privacidad" target="_blank" rel="noopener noreferrer">política de privacidad</a>.',
      errors: {
        name: 'Introduce tu nombre.',
        email: 'Introduce un email válido.',
        year_required: 'Introduce el año de nacimiento.',
    ...
    result: {
      ...
      intro: 'Pincha en cada trastorno para ver el diagnóstico y el remedio.',
      has_stages_headline: 'Tu corazón muestra tendencias hacia una o más de las enfermedades espirituales. Trabájalas.',
