...
const HOME_SEO = {
  es: { title: 'Virtuous Leadership Programs for Educational Institutions', description: 'Igniting hearts for greatness.' },
  en: { title: 'Virtuous Leadership Programs for Educational Institutions', description: 'Igniting hearts for greatness.' },
  fr: { title: 'Virtuous Leadership Programs for Educational Institutions', description: 'Igniting hearts for greatness.' },
  ru: { title: 'Virtuous Leadership Programs for Educational Institutions', description: 'Igniting hearts for greatness.' },
};
